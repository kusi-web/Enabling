...
class AccountJournal(models.Model):
    ...
    lyra_company_sequence = fields.Many2one('ir.sequence', string="Lyra Sequence",copy=False)
    lyra_company_refund_sequence = fields.Many2one('ir.sequence', string="lyra refund sequence")
